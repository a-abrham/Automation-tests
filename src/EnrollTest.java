        ...
        public static void enroll(WebDriver driver) throws InterruptedException {
                ...
                WebElement learningpath = driver
                                .findElement(By.xpath(
                                                "//*[@id=\"root\"]/div/div[1]/div/div/div/div[2]/div/ul/li[1]/a"));
                learningpath.click();
                ...
                WebElement course = driver
                                .findElement(By.xpath("//*[@id='ct-path-area']/div/div[2]/a/div/div[2]/div[1]"));
                course.click();
                ...
                if (buttonText.contains("Resume")) {
                        ...
                        System.out.println("User Enrolled: Test Passed");

                        wait = new WebDriverWait(driver, Duration.ofSeconds(10));
                        WebElement okbtn = wait.until(ExpectedConditions
                                        .elementToBeClickable(By.xpath("/html/body/div[3]/div/div[4]/div/button")));
